  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.token) {
        ...
        localStorage.setItem("educart_token", data.token);
        localStorage.setItem("educart_user", JSON.stringify(data.user));
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">EDUCART</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="admin@educart.com.br"
              />
            </div>
          </div>
